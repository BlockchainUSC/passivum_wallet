...
export default function Home() {
  ...
  return (
    <main
      className={`flex min-h-screen flex-col items-center justify-between p-24 overflow-y-scroll ${inter.className}`}
    >
      ...
      <div className="mt-28 text-3xl flex place-items-center before:absolute before:h-[300px] before:w-[480px] before:-translate-x-1/2 before:rounded-full before:bg-gradient-radial before:from-white before:to-transparent before:blur-2xl before:content-[''] after:absolute after:-z-20 after:h-[180px] after:w-[240px] after:translate-x-1/3 after:bg-gradient-conic after:from-sky-200 after:via-blue-200 after:blur-2xl after:content-[''] before:dark:bg-gradient-to-br before:dark:from-transparent before:dark:to-blue-700/10 after:dark:from-sky-900 after:dark:via-[#0141ff]/40 before:lg:h-[360px]">
        PASSIVUM WALLET
      </div>
      ...
      <div className="flex flex-col lg:flex-row text-center lg:text-left ">
        <a
          href="/AddFriends"
          className="lg:mr-10 w-1/2 group rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-gray-300 hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30"
          rel="noopener noreferrer"
